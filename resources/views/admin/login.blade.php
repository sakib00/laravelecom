                           ...
                           {{ csrf_field() }}
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control"  value="" name="email" type="email" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" value=""  name="password" type="password" value="">
                                </div>
                                <div class="checkbox">
                                    <label>
                                ...
                                <button class="btn btn-lg btn-success btn-block">Click To Login</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
